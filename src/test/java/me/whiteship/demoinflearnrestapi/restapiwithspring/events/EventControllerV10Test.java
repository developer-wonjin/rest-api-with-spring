...
public class EventControllerV10Test {
    @Autowired
    MockMvc mockMvc;
    ...
    @DisplayName("스프링HATEOS적용" +
            "https://www.inflearn.com/courses/lecture?courseId=239527&unitId=16427&subtitleLanguage=ko")
    @Test
    void createEvent() throws Exception {
        ...
        mockMvc.perform(post("/api/v10/events")
